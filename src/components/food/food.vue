			...
			<div class="food-content">
				...
				<div class="content">
					...
					<div class="detail1">
						...
						<span class="rating">好评论{{food.rating}}</span>
					</div>
					<div class="price">
					...
					<div class="cartcontrol-wrapper1">
						<cartcontrol :food="food"></cartcontrol>
					</div>
					<div class="buy1" v-show="!food.count||food.count===0" @click.stop.prevent="addFirst">
						加入购物车
					</div>
				</div>
...
import ratingselect from "../ratingselct/ratingselect.vue"
...
const all=2;
    export default{
      ...
      created() {
            // 获取子组件的selectType的更新
            this.$on('ratingtype.select', selectType => {
